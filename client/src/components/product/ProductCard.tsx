...
export default function ProductCard({
  ...
  return (
    <>
      ...
      >
        {/* Image section clickable with Wouter Link */}
        <Link
        ...
        <CardContent className="p-4 flex flex-col flex-grow">
          <h3
            className="font-semibold mb-2 line-clamp-2 h-10"
          ...
          <div className="flex items-center justify-between mb-3">
            ...
            <div className="flex items-center gap-3 text-muted-foreground">
              <div
                ...
                title={`${productStats?.likes || 0} likes`}
              >
                <FaHeart className="w-3 h-3" />
                <span
                  className="text-sm"
                  data-testid={`product-likes-${product.id}`}
                >
              ...
              <div
                className="flex items-center gap-1"
                title={`${productStats?.comments || 0} comments`}
              >
                <FaComment className="w-3 h-3" />
                <span
                  className="text-sm"
                  data-testid={`product-comments-${product.id}`}
                >
